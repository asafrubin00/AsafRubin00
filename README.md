...
| [**OneNote2Notion**](https://github.com/asafrubin00/asaf-cv-chatbot) | AOneNote → Notion migration tool — Python CLI that exports full notebooks including images via Microsoft Graph API. | [View →](https://github.com/asafrubin00/onenote2notion) |
